...
console.log(`trigger-board validation passed: research ${board.researchState}, ${board.events.length} actionable event(s), ${buys.length} competing buy(s), 20/10 stock timing, A-first then B<=25%`);
