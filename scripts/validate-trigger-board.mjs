...
const fail=[];
if(board.schemaVersion!==3)fail.push('schemaVersion');
...
console.log(`trigger-board validation passed: research ${board.researchState}, ${board.events.length} actionable event(s), ${buys.length} competing buy(s)`);
