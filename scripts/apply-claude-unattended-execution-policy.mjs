...
const policy={
  ...
  exits:{
    ...
    scope:['TRIGGER_1_STOP','STOCK_DAY_TRADE_FORCED_EXIT','TRIGGER_2_TARGET1','TRIGGER_3_TARGET2','TRIGGER_EARLY_PROFIT_TRIM','CRYPTO_STOP','CRYPTO_TARGET','CRYPTO_TIME_EXIT','EMERGENCY_PROTECTION_EXIT']
  },
