...
test('admitted options can keep the live executor awake without a stock position',()=>{assert.match(liveCycle,/option_routine/);assert.match(liveCycle,/MICRO_PROBATION/);assert.match(liveCycle,/LIVE_ADMITTED/);});
