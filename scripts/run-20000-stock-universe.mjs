...
source=source
  ...
  .replace('const HISTORY_POOL=800;','const HISTORY_POOL=20000;')
  .replace('const VALIDATION_POOL=300;','const VALIDATION_POOL=20000;')
  ...
  .replaceAll('top 800 daily-history analysis','every discovered stock daily-history analysis (up to 20,000)')
  .replaceAll('top 300 setup-specific','every discovered stock setup-specific')
