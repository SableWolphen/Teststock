...
if(seedLaneConfig.enabled===true){
  ...
  // Publish enough ranked fallbacks to fill the remaining concurrent capacity. These are choices,
  // not extra daily slots: the executor enforces dailyRemaining against Robinhood-confirmed state
  // and may open at most one of them today.
