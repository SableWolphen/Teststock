...
Options remain separate from automatic stock entry execution unless the current Teststock option policy explicitly marks an option order executable. Do not infer options authorization from stock automation.
